    ...
    <>
      ...
      <main id="main">
        ...
        <section className="section" aria-labelledby="data">
          ...
          <p>
            Източниците са Агенцията по обществени поръчки (АОП) и ЦАИС ЕОП чрез отворените данни
            от storage.eop.bg. Когато данните съдържат лични данни, уведомяването се
        ...
        <section className="section" aria-labelledby="logs">
          <h2 id="logs">Технически дневници</h2>
          <p>
            За сигурност, предотвратяване на злоупотреби и нормална работа на услугата СИГМА води
            кратки технически дневници на заявките. Всеки запис включва дата и час, заявения път
            (без съдържанието на заявката за търсене), HTTP статус, времетраене на обработката и
