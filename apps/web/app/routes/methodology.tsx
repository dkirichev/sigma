...
export function meta(_: Route.MetaArgs) {
  return [
    ...
    {
      name: 'description',
      content: 'Откъде идват числата, как се сглобяват и какво нарочно не показваме.',
    },
  ];
}
...
const TOC = [
  ...
  ['export', 'Експорт и достъп до данните'],
        ...
        <div className="split">
          ...
          <div>
            <section className="section" aria-labelledby="what">
              ...
              <p>
                Сигма е публичен изследовател на обществените поръчки в България. Показва{' '}
              ...
              <ul>
                ...
                <li>
                  <strong>Договори</strong> — атомният запис. Всеки агрегат се разлага до
                  конкретните договори, които го съставят.
                </li>
              </ul>
              <p>
                Поведението е изцяло „за четене". Сигма не въвежда нови данни, не оценява
                процедурите и не маркира фирми като рискови.
              </p>
              <Callout title="За какво е подходяща тази версия">
                <p style={{ margin: 0 }}>
                  Журналисти, изследователи, общински съветници, НПО и граждани, които искат да
                  тръгнат от име на институция или фирма и да стигнат до конкретните договори. Не е
                  заместител на правен или одиторски анализ.
                </p>
              </Callout>
            </section>
            ...
            <section className="section" aria-labelledby="source">
              ...
              <dl className="facts">
                ...
                <div className="row">
                  ...
                  <dd>
                    Поръчки под прага за обявяване се появяват само ако възложителят е публикувал
                    договор. Поръчки в отбраната и сигурността по специален ред — не.
                  </dd>
                </div>
                <div className="row">
            ...
            <section className="section" aria-labelledby="unit">
              <h2 id="unit">3. Атомен запис: договорът</h2>
              <p>
                Един <strong>сключен договор</strong> (или една обособена позиция от многолотова
                процедура) е най-малката единица, която Сигма показва. Всичко друго — сума за
                институция, обем за компания, поток между двете — е сума или брой над списък от
                такива договори.
              </p>
              <Callout title="Защо не показваме офертите по отделните участници">
                <p style={{ margin: 0 }}>
            ...
            <section className="section" aria-labelledby="principles">
              ...
              <ol className="principles">
                <li>
                  <strong>Числото винаги се разлага до своите договори.</strong> Всеки общ обем има
                  връзка „виж договорите". Ако не може да се разложи, не го показваме.
                </li>
                <li>
                ...
                <li>
                  <strong>Сигма не интерпретира, показва.</strong> Класирания, дялове и съотношения
                  са неутрални числа; читателят прави извод сам.
                </li>
                <li>
                  <strong>Споделими адреси за всяка гледна точка.</strong> Филтрите се кодират в URL
                  — всяка комбинация има постоянен адрес.
                </li>
                <li>
                  <strong>Никакво съхранение на действия от потребителя.</strong> Няма регистрация,
                  няма проследяване.
                </li>
                <li>
                  <strong>Празно поле е по-добро от измислена стойност.</strong> Когато източникът
                  не носи стойност, показваме „—".
                </li>
              </ol>
            </section>
            ...
            <section className="section" aria-labelledby="glossary">
              ...
              <dl className="glossary">
                ...
                <dd>
                  <p>
                    Публична организация, която провежда поръчката. Различните начини, по които АОП
                    изписва името ѝ, се сливат в един каноничен запис.
                  </p>
                ...
                <dd>
                  <p>
                    Детерминирана група, изведена от CPV кода: разделът (първите две цифри) — напр.
                    45 → строителство, 33 → медицина и лекарства. Не е евристика, а етикет от
                    каталога CPV 2008.
                  </p>
                ...
                <dd>
                  <p>
                    ...
                    период — изчислена величина, която винаги се разлага до договорите си.
                  </p>
            ...
            <section className="section" aria-labelledby="identity">
              ...
              <ul>
                ...
                <li>
                  <strong>Имена</strong> се показват както са в източника (запазена е и оригиналната
                  пунктуация) — показваме източниковата истина.
                </li>
                <li>
            ...
            <section className="section" aria-labelledby="export">
              <h2 id="export">9. Експорт и достъп до данните</h2>
              <p>
                Всеки списък може да бъде експортиран като CSV — точно това, което виждате, с
                приложените филтри:
              </p>
              <ul>
                <li>
              ...
              <p>Не поддържаме (засега) публично API в реално време.</p>
            </section>

            <section className="section" aria-labelledby="contact">
              <h2 id="contact">10. Поправки и обратна връзка</h2>
              <p>
                Грешки се поправят ръчно при сигнал — двойни записи на институция/компания
                (изпратете двата ЕИК/URL) или сума, която не отговаря на оригиналния документ
                (изпратете УНП).
              </p>
              <p>
